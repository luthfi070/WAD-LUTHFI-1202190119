...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-4">
            ...
            >
                @method('PUT') @csrf @foreach($vaccines as $vac)
                <input type="hidden" value="{{ $vac->id }}" name="id">
                ...
                <div class="form-group">
                    ...
                    <textarea
                        ...
                        id="desc"
                        name="desc"
                        >{{ $vac->description }}</textarea
                    >
                </div>
                <div class="form-group">
                    <label for="image"
                        >Images ( Gambar saat ini akan muncul dibawah )</label
                    >
                    <br />
                    <img class="mb-2" src={{ asset('storage/' . $vac->image)}}
